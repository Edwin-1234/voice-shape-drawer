...
# Word to shape mapping (expandable)
shape_map = {
    'circle': 'circle',
    'square': 'square',
    'triangle': 'triangle',
...
print("🎤 Speak a sentence like 'draw star and circle' or say 'stop' to exit.")

with mic as source:
    recognizer.adjust_for_ambient_noise(source)  # Helps with noise
